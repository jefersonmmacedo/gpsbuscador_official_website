...
import { IoDocumentTextOutline, IoCaretForwardOutline, IoLocationOutline, IoCloseOutline } from "react-icons/io5";
        ...
        <div className="ProposalHome">
            ...
            <div className="proposalItens">
                <div className="proposalList">
                    ...
                    <a href="/propostas">VER TODAS AS PROPOSTAS</a>

                </div>

                <div className="proposalView">
                    <div className="block1">
                    <h3><IoCaretForwardOutline />CONTRUÇÃO DE MURO</h3>
                    <h5>Construção de muro em volta de terreno, tamanho 12x30</h5>
                    <div className="professionals">
                        <p>Profissão</p>
                        <p>Profissão</p>
                    ...
                    <button onClick={handleNewProposal}>Enviar e Orçamento</button>
                    </div>
                </div>
            </div>
